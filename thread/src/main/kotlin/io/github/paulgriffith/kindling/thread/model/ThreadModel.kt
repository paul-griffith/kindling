...
//    override val threadData: List<ThreadLifespan>
//) : ThreadModel<ThreadLifespan>(threadData, ThreadColumns) {
//
//    override fun isCellEditable(rowIndex: Int, columnIndex: Int): Boolean {
...
//    override val threadData: List<Thread>
//) : ThreadModel<Thread>(threadData, ThreadColumns) {
//
//    override fun isCellEditable(rowIndex: Int, columnIndex: Int): Boolean {
//        return columnIndex == ThreadColumns[Mark]
//    }
...
//    override fun setValueAt(aValue: Any?, rowIndex: Int, columnIndex: Int) {
//        check(columnIndex == ThreadColumns[Mark])
//        threadData[rowIndex].marked = aValue as Boolean
//    }
//
//    @Suppress("unused", "MemberVisibilityCanBePrivate")
